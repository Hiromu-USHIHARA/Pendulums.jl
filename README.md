...
where $\Omega_\pm:=\sqrt{\dfrac{g}{L}\left(2\pm\sqrt2\right)}$. The comparison between the numerically obtained solution and the analytical expression for $\theta_1(t)$ and $\theta_2(t)$ shows the good agreement!
